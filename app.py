...
def upload():
    ...
    if __name__ == '__main__':
      ...
      #print(billno['word'])
      fullTitle=' '.join(title.word)
      fullFullname=' '.join(fullname.word)
      fullCardid=' '.join(cardid.word)
      fullEdate=' '.join(edate.word)

    return render_template("processing.html", image_name=filename, hel=fullTitle, hel2=fullFullname, hel3=fullCardid, hel4=fullEdate)
